...
from service_sql import create_todo, delete_status_todo, read_all_todo, read_id_todo, update_status_todo
...
@router.put("/update_todo_={id_todo}", summary="Atualizar o status de uma tarefa", status_code=status.HTTP_200_OK)
async def update(id_todo : int) -> list:
    #print(id_todo)
    try:
